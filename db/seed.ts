...
const works: schema.InsertWork[] = [
  // PINTURAS
  { slug: "camaleao", title: "Camaleão", category: C.PINTURAS, technique: "Pintura sobre tela", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/work-12.jpg", sortOrder: 1,
  ...
  { slug: "revoada", title: "Revoada", category: C.PINTURAS, technique: "Pintura sobre tela", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/work-14.jpg", sortOrder: 2,
  ...
  { slug: "tiradentes-panel", title: "Tiradentes", category: C.PINTURAS, technique: "Pintura sobre madeira de demolição", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/work-13.jpg", sortOrder: 3,
  ...
  { slug: "noite-tropical", title: "Noite Tropical", category: C.PINTURAS, technique: "Pintura sobre tela", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/pintura-tropical.jpg", sortOrder: 4,
  ...
  { slug: "cupido", title: "Cupido", category: C.PINTURAS, technique: "Pintura sobre tábuas de demolição", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/work-11.jpg", sortOrder: 5,
  ...
  { slug: "guardiao", title: "Guardião", category: C.ESCULTURAS, technique: "Papel machê, cocar de varetas pintadas", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/work-2.jpg", sortOrder: 7,
  ...
  { slug: "araras", title: "Araras", category: C.ESCULTURAS, technique: "Escultura de parede pintada à mão", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/work-5.jpg", sortOrder: 8,
  ...
  { slug: "ancionais", title: "Ancionais", category: C.CEU_ABERTO, technique: "Papel machê em grande escala, uso externo", status: "NO JARDIM", year: "2026", price: "Sob consulta", image: "/images/work-3.jpg", sortOrder: 9,
  ...
  { slug: "capivaras", title: "Capivaras", category: C.CEU_ABERTO, technique: "Conjunto em metal recortado e pintado", status: "NO JARDIM", year: "2026", price: "Sob consulta", image: "/images/work-8.jpg", sortOrder: 10,
  ...
  { slug: "veados", title: "Veados", category: C.CEU_ABERTO, technique: "Metal de reúso, asas em chapa pintada", status: "NO JARDIM", year: "2026", price: "Sob consulta", image: "/images/work-9.jpg", sortOrder: 11,
  ...
  // CIRCO & FORMA
  { slug: "dalmata", title: "Dálmata", category: C.CIRCO, technique: "Pintura sobre fundo xadrez óptico", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/work-15.jpg", sortOrder: 12,
  ...
  { slug: "tenis-xadrez", title: "Tênis Xadrez", category: C.CIRCO, technique: "Pintura, ilusão de ótica", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/circo-tenis.jpg", sortOrder: 13,
  ...
  { slug: "arlequins", title: "Arlequins", category: C.CIRCO, technique: "Pintura emoldurada, série circo", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/circo-harlequins.jpg", sortOrder: 14,
  ...
  // RECORTES
  { slug: "lobo-guara", title: "Lobo-Guará", category: C.RECORTES, technique: "Recorte em chapas de metal de reúso", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/work-6.jpg", sortOrder: 15,
  ...
  { slug: "onca", title: "Onça", category: C.RECORTES, technique: "Metal recortado e pintado", status: "DISPONÍVEL", year: "2026", price: "Sob consulta", image: "/images/work-7.jpg", sortOrder: 16,
  ...
  { slug: "seriemas", title: "Seriemas", category: C.RECORTES, technique: "Metal recortado, conjunto de aves", status: "NO JARDIM", year: "2026", price: "Sob consulta", image: "/images/work-10.jpg", sortOrder: 17,
  ...
  // ARTE AMBIENTAL
  { slug: "guardioes-da-encosta", title: "Guardiões da Encosta", category: C.AMBIENTAL, technique: "Papel machê monumental in situ", status: "NO JARDIM", year: "2026", price: "Sob consulta", image: "/images/ambiental-mascaras.jpg", sortOrder: 18,
  ...
  { slug: "vigia", title: "Vigia", category: C.AMBIENTAL, technique: "Papel machê e metal de reúso", status: "NO JARDIM", year: "2026", price: "Sob consulta", image: "/images/work-4.jpg", sortOrder: 19,
...
async function seed() {
  ...
  const existingWorks = await db.select().from(schema.works).limit(1);
  if (existingWorks.length === 0) {
    await db.insert(schema.works).values(works);
    console.log(`Inserted ${works.length} works.`);
  } else {
    console.log("Works already seeded, skipping.");
  }
