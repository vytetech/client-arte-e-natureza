...
const pt: Dict = {
  ...
  "nav.menu": "Menu",
  "nav.logo_home": "Ir para o início",
  ...
  "od.variants_title": "Tamanhos disponíveis",
  "od.select_variant": "Selecionar variação",
  "od.selected_variant": "Variação selecionada",
  "od.dimensions": "Dimensões",
  "od.edition": "Edição",
  "od.unique_piece": "Peça única",
  "od.variant_whatsapp_message": "Olá! Tenho interesse na obra \"{title}\", variação \"{variant}\", {price}.",
  ...
  "cafe.hero.description": "Registros publicados pelo ateliê: pequenos encontros, imagens e histórias que aproximam a criação da vida diária.",
  "cafe.eyebrow": "Espaço de Café",
  "cafe.title": "Um encontro entre arte, conversa e cotidiano",
  "cafe.intro": "Registros publicados pelo ateliê: pequenos encontros, imagens e histórias que aproximam a criação da vida diária.",
  "cafe.open": "Visitar o Espaço de Café",
  "cafe.empty": "Nenhum conteúdo publicado no momento.",
  "cafe.media_alt": "Registro do Espaço de Café",
...
const en: Dict = {
  ...
  "od.variants_title": "Available sizes",
  "od.select_variant": "Select variation",
  "od.selected_variant": "Selected variation",
  "od.dimensions": "Dimensions",
  "od.edition": "Edition",
  "od.unique_piece": "Unique piece",
  "od.variant_whatsapp_message": "Hello! I am interested in the work \"{title}\", variation \"{variant}\", {price}.",
  ...
  "cafe.hero.eyebrow": "Coffee Space",
  "cafe.hero.title": "A meeting point for art, conversation and everyday life",
  "cafe.hero.description": "Published notes from the studio: small encounters, images and stories that bring the creative process closer to daily life.",
  "cafe.eyebrow": "Coffee Space",
  "cafe.title": "A meeting point for art, conversation and everyday life",
  "cafe.intro": "Published notes from the studio: small encounters, images and stories that bring the creative process closer to daily life.",
  "cafe.open": "Visit the Coffee Space",
  "cafe.empty": "No published content at the moment.",
  "cafe.media_alt": "Coffee Space entry",
...
const es: Dict = {
  ...
  "od.variants_title": "Tamaños disponibles",
  "od.select_variant": "Seleccionar variación",
  "od.selected_variant": "Variación seleccionada",
  "od.dimensions": "Dimensiones",
  "od.edition": "Edición",
  "od.unique_piece": "Pieza única",
  "od.variant_whatsapp_message": "¡Hola! Tengo interés en la obra \"{title}\", variación \"{variant}\", {price}.",
  ...
  "cafe.hero.eyebrow": "Espacio de Café",
  "cafe.hero.title": "Un encuentro entre arte, conversación y vida cotidiana",
  "cafe.hero.description": "Registros publicados por el atelier: pequeños encuentros, imágenes e historias que acercan la creación a la vida diaria.",
  "cafe.eyebrow": "Espacio de Café",
  "cafe.title": "Un encuentro entre arte, conversación y vida cotidiana",
  "cafe.intro": "Registros publicados por el atelier: pequeños encuentros, imágenes e historias que acercan la creación a la vida diaria.",
  "cafe.open": "Visitar el Espacio de Café",
  "cafe.empty": "No hay contenido publicado en este momento.",
  "cafe.media_alt": "Registro del Espacio de Café",
...
const ar: Dict = {
  ...
  "nav.menu": "القائمة",
  "nav.logo_home": "الذهاب إلى الرئيسية",
  ...
  "od.variants_title": "المقاسات المتاحة",
  "od.select_variant": "اختيار التنويعة",
  "od.selected_variant": "التنويعة المختارة",
  "od.dimensions": "الأبعاد",
  "od.edition": "الإصدار",
  "od.unique_piece": "قطعة فريدة",
  "od.variant_whatsapp_message": "مرحبًا! لدي اهتمام بالعمل \"{title}\"، التنويعة \"{variant}\"، {price}.",
  ...
  "cafe.hero.eyebrow": "مساحة القهوة",
  "cafe.hero.title": "لقاء بين الفن والحوار والحياة اليومية",
  "cafe.hero.description": "مواد منشورة من المرسم: لقاءات صغيرة وصور وحكايات تقرّب عملية الخلق من تفاصيل الحياة اليومية.",
  "cafe.eyebrow": "مساحة القهوة",
  "cafe.title": "لقاء بين الفن والحوار والحياة اليومية",
  "cafe.intro": "مواد منشورة من المرسم: لقاءات صغيرة وصور وحكايات تقرّب عملية الخلق من تفاصيل الحياة اليومية.",
  "cafe.open": "زيارة مساحة القهوة",
  "cafe.empty": "لا يوجد محتوى منشور حاليًا.",
  "cafe.media_alt": "منشور من مساحة القهوة",
