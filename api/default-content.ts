...
export const defaultSettings: Record<string, string> = {
  ...
  "contact.whatsapp.1.enabled": "1",
  "contact.whatsapp.1.number": "5532984527407",
  "contact.whatsapp.1.purpose": "visits",
  "contact.whatsapp.1.order": "1",
  "contact.whatsapp.1.description.pt": "Visitas e agendamentos no ateliê",
  "contact.whatsapp.1.description.en": "Studio visits and appointments",
  "contact.whatsapp.1.description.es": "Visitas y reservas en el atelier",
  "contact.whatsapp.1.description.ar": "زيارات المرسم وحجز المواعيد",
  "contact.whatsapp.2.enabled": "0",
  "contact.whatsapp.2.number": "",
  "contact.whatsapp.2.purpose": "sales",
  "contact.whatsapp.2.order": "2",
  "contact.whatsapp.2.description.pt": "Compra e informações sobre obras",
  "contact.whatsapp.2.description.en": "Purchases and information about works",
  "contact.whatsapp.2.description.es": "Compra e información sobre obras",
  "contact.whatsapp.2.description.ar": "شراء الأعمال والاستفسار عنها",
  "section.manifesto": "1",
...
const defaultWorksBase: Omit<Work, "couponEnabled" | "isUniquePiece" | "editionNumber" | "editionTotal" | "editionLabel" | "widthCm" | "heightCm" | "thicknessCm">[] = [
